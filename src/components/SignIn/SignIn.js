import React from 'react';
 ...
 class SignIn extends React.Component {
  ...
  The last button in a form fires a submit event as a get request if nothing 
  ...
  which forces the browser to reload the entire page.*/
    ...
    render(){
        ...
        return (
            <article className="br4 ba dark-gray b--black-10 mv4 w-180 w-50-m m-25-l mw6 shadow-5 center">
